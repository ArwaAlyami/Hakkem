...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('hakkem\css\Journals\Accepted-Request.css') }}">
...
<body>
    ...
    <div class="container">
        ...
        <div class="footer-buttons">
            <button class="reject">Reject Publication</button>
            <button class="accept">Accept Publication</button>
        </div>
    </div>
    <!-- Overlay -->
