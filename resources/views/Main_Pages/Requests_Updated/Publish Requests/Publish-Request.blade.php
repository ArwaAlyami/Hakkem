...
<head>
    ...
    <title>Publish Request Steps</title>
    <link rel="stylesheet" href="{{ asset('css\MainPages\Requests\Publish-Request.css') }}" />
</head>
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-step">
            <div class="content">
                <h2>Choose Journal To Receive Your Request</h2>
                <label>Scientific Journal:</label>
                <div class="dropdownlist">
                    <select id="researchField">
                        <option value="">Select Field</option>
                        <option id="Journal">
                ...
                <p>
                    Price offer:
                    <strong><span id="riyal" class="icon icon-home"></span> 1,000.00</strong>
                </p>
            </div>
            <div class="buttons">
                ...
                <div class="Req-Details">
                    ...
                    <div class="row">
                        ...
                        <div class="col2">
                            ...
                            <p>Publish Request</p>
                            <p>
                                International Journal of CS & Information Security (IJCSIS)
                            </p>
                            <!-- حالة الطلب -->
                            <div class="state">
                                <img src="{{ asset('/images/Requests/timefill.svg') }} " />
                    ...
                    <div class="row">
                        ...
                        <div class="col2">
                            ...
                            <p><span id="riyal" class="icon icon-home"></span>2,100.00</p>
                        </div>
                    </div>
                </div>
            </div>
