...
<head>
    <link rel="stylesheet" href="{{ asset(path: 'css\usercontainer.css') }}" />
</head>
...
<body>
    ...
    <div class="profile-content">
        ...
        <header>
            <h1 class="profile-name">Dr. Abdullah Al-Ghamdi</h1>
        </header>

        <!-- Where the Reviewer is from -->
        <section class="profile-details">
            <p class="department-info">
                <span class="department">Department of Computer Information Systems</span>
