        ...
        <div class="container">
          ...
          ----------------------------->
            <div class="form-step">
              ...
              -->
                    <div class="searchbar">
                        <input type="search" class="inp" id="userId" placeholder="Search user ID ..." size="30"
                            onchange="profileCard()" required />
                    </div>
                ...
                <div class="content">
                    ...
                    <div class="trans-details">
                        ...
                        <div class="setPrice-row">
                            ...
                            <div class="price-inp">
                                <span class="currency"><span id="riyal" class="icon icon-home"></span></span>
                                <input type="number" id="price-input" max="50000" onchange="return check()" required />
                            </div>
                        </div>
